...
public class UserInterface {
	...
	**********************************************************************************************/
	...
	public UserInterface(Pane theRoot) {
		...
		theRoot.getChildren().addAll(label_FileName, text_FileName, 
...
//			board = evenGameBoard;
//		}
//		//Rectangle rect_outer1 =  new Rectangle(0,0,ConwayMain.WINDOW_WIDTH, controlPanelHeight-5);
//		//Rectangle rect_middle1 = new Rectangle(5,5,ConwayMain.WINDOW_WIDTH-10, controlPanelHeight-15);
//		//Rectangle rect_inner1 =  new Rectangle(6,6,ConwayMain.WINDOW_WIDTH-12, controlPanelHeight-17);
//
//		for (int i = 0; i < board.rows; i++) {
//            for (int j = 0; j < board.columns; j++) {
//            	// Rectangle rect_outer1 =  new Rectangle(0,0,ConwayMain.WINDOW_WIDTH, controlPanelHeight-5);
//        		Rectangle rect_middle1 = new Rectangle(i * this.cellSize, j * this.cellSize, this.cellSize, this.cellSize);
//        		Rectangle rect_inner1 =  new Rectangle((i * this.cellSize) + 1, (j * this.cellSize) + 1, this.cellSize - 2, this.cellSize - 2);
//            	
//                if (board.grid[i][j].isAlive == true) {
//                    // first rect will end up becoming the border
//                	rect_middle.setFill(Color.BLACK);
//            		rect_inner.setFill(Color.PURPLE);   
//                }else {
//                	rect_middle.setFill(Color.BLACK);
//            		rect_inner.setFill(Color.WHITE);
//                }
//                
//                window.getChildren().addAll(rect_middle1, rect_inner1);
//            }
//        }
//		
//		// window.getChildren().add(c);
